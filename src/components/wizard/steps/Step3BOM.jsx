  ...
  return (
    <div>
      ...
      <div style={{ overflowX: 'auto' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 820, marginBottom: 12 }}>
          <thead>
            <tr>
            ...
            {tabItems.map(item => {
              ...
              return (
                <tr key={item.id || item._tempId}>
                  ...
                  <td style={{ padding: '4px 4px', borderBottom: '1px solid #f0f0ee', minWidth: 220 }}>
                    {activeTab === 'Fabric' ? (
                      <div style={{ display:'flex', gap:6, alignItems:'center' }}>
                        <input style={{ ...inp, flex: 1.2 }} value={item.name || ''} onChange={e => upd(realIdx, 'name', e.target.value)} placeholder="Fabric name" />
                        <input style={{ ...inp, flex: 1 }} value={item.specification || ''} onChange={e => upd(realIdx, 'specification', e.target.value)} placeholder="Shade / Colour" />
                      </div>
                    ) : (
                      <input style={inp} value={item.name || ''} onChange={e => upd(realIdx, 'name', e.target.value)} placeholder="Item name" />
                    )}
                  </td>
                  <td style={{ padding: '4px 4px', borderBottom: '1px solid #f0f0ee', minWidth: 180 }}>
                  ...
                  <td style={{ padding: '4px 4px', borderBottom: '1px solid #f0f0ee', width: 160 }}>
                    <div style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
                      <select style={{ ...sel, flex: 1, minWidth: 132, color: !isGeneric ? '#2563eb' : undefined, fontWeight: !isGeneric ? 600 : undefined }}
