  ...
  return (
    <div>
      ...
      <div style={{ overflowX: 'auto' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 860, marginBottom: 12 }}>
          <thead>
            <tr>
            ...
            {tabItems.map(item => {
              ...
              return (
                <tr key={item.id || item._tempId}>
                  ...
                  <td style={{ padding: '4px 4px', borderBottom: '1px solid #f0f0ee', minWidth: 240 }}>
                    {activeTab === 'Fabric' ? (
                      <input
                        style={inp}
                  ...
                  <td style={{ padding: '4px 4px', borderBottom: '1px solid #f0f0ee', width: 96, minWidth: 96 }}>
