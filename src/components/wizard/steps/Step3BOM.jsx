            ...
            {tabItems.map(item => {
              ...
              return (
                <tr key={item.id || item._tempId}>
                  ...
                  <td style={{ padding: '4px 4px', borderBottom: '1px solid #f0f0ee', width: '26%' }}>
                    {activeTab === 'Fabric' ? (
                      <input
                        style={inp}
                  ...
                  <td style={{ padding: '4px 4px', borderBottom: '1px solid #f0f0ee', width: '20%' }}>
                  ...
                  <td style={{ padding: '4px 4px', borderBottom: '1px solid #f0f0ee', width: '16%' }}>
                  ...
                  <td style={{ padding: '4px 4px', borderBottom: '1px solid #f0f0ee', width: '10%', textAlign: 'right' }}>
                    {fqty ? (() => {
