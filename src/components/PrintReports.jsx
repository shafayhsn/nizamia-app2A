...
const PRINT_CSS = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .doc-header-left .brand-name { font-size: 15px; font-weight: 700; letter-spacing: -0.3px; line-height: 1; }
  ...
  .doc-header-right .doc-title { font-size: 22px; font-weight: 700; letter-spacing: -0.5px; line-height: 1.1; }
  ...
  .kpi-value { font-size: 22px; font-weight: 700; letter-spacing: -0.5px; line-height: 1; }
  ...
  .sample-logo-text .brand { font-size: 12px; font-weight: 700; letter-spacing: -0.3px; }
  ...
  .sample-num { font-size: 14px; font-weight: 700; font-family: 'Courier New', monospace; letter-spacing: -0.5px; }
  ...
  .sample-cell-value.large { font-size: 12px; font-weight: 700; }
  ...
  .po-number { font-size: 22px; font-weight: 700; font-family: 'Courier New', monospace; letter-spacing: -0.5px; margin-bottom: 10px; }
  ...
  .po-supplier-name { font-size: 14px; font-weight: 700; margin-bottom: 4px; }
  ...
  .po-total-row.grand { font-weight: 700; font-size: 13px; border-top: 1.5px solid #0d0d0d; border-bottom: none; padding-top: 6px; margin-top: 4px; }
