...
export async function printPurchaseOrder(po, supplier, order, taxRate, targetWindow = null) {
  ...
  const effectiveTaxRate = taxRate ?? (storedTax?.enabled ? storedTax.rate : null)
  ...
  const tax = effectiveTaxRate ? subtotal * (effectiveTaxRate/100) : 0
  ...
  <div class="page">
    ...
    <div class="po-header-box">
      <div class="po-left">
        ...
        <div class="po-meta-row">
          <div class="po-meta-item"><div class="lbl">Q# Reference</div><div class="val">${qReference}</div></div>
    ...
    <table>
      <thead><tr><th>#</th><th>Item Description</th><th>Break-down</th><th class="right">Quantity</th><th>Unit</th><th class="right">Unit Rate (${po.currency||'PKR'})</th><th class="right">Amount (${po.currency||'PKR'})</th></tr></thead>
      <tbody>${itemRows}</tbody>
    </table>
    <div class="po-totals">
      <div class="po-total-row"><span>Subtotal</span><span>${po.currency||'PKR'} ${fmtNum(subtotal,0)}</span></div>
      ${effectiveTaxRate ? `<div class="po-total-row"><span>GST ${effectiveTaxRate}%</span><span>${po.currency||'PKR'} ${fmtNum(tax,0)}</span></div>` : ''}
