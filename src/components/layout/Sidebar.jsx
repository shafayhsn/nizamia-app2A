...
import {
  ...
  Printer, StickyNote, UserCircle, ClipboardCheck, Send, CalendarCheck,
} from 'lucide-react'
...
const NAV = [
  ...
  { to: '/shipping',   icon: CalendarCheck,   label: 'Booking & Shipping' },
    ...
    <>
      <aside style={{
        ...
        <div style={{
          ...
          padding: collapsed ? '0 10px' : '0 12px 0 14px', borderBottom: `1px solid ${SB_BORDER}`,
          ...
          <div style={{
            ...
            <img
              ...
              style={collapsed ? {
                ...
                width: 150, height: 36, objectFit: 'contain', objectPosition: 'left center', display: 'block',
              }}
            />
          </div>
          {!collapsed && (
            <button onClick={() => setCollapsed(true)} aria-label="Collapse sidebar" style={{
              background: 'none', border: 'none', cursor: 'pointer',
              color: SB_TEXT, padding: 3, display: 'flex', flexShrink: 0, borderRadius: 4, marginLeft: 6,
            }}>
              <ChevronLeft size={15} />
            </button>
          )}
