...
import { Bell, Cloud, CloudOff, RefreshCw, AlertCircle, LogOut } from 'lucide-react'
...
export default function Topbar() {
  ...
  return (
    <header style={{
      ...
      {user && (
        <button onClick={logout} title="Logout" style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#6b7280', padding: 4, display: 'flex', borderRadius: 6, marginRight: 8 }}
