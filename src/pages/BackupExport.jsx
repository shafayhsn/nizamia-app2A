      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        ...
        <section style={panelStyle}>
          ...
          <div style={noticeStyle('#fef2f2', '#fecaca', '#991b1b')}>
            ...
            <div>
              <div style={{ fontWeight: 700, marginBottom: 4 }}>Danger Zone</div>
          ...
          {restoreInfo && (
            <div style={{ border: '1px solid #e5e7eb', borderRadius: 10, padding: 12, marginTop: 12, background: '#fff' }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#111827', marginBottom: 8 }}>Backup selected</div>
              ...
              <div style={{ marginTop: 12 }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: '#374151', marginBottom: 6 }}>Type RESET to confirm</div>
          ...
          {progress && <div style={{ fontSize: 12, color: restoreLoading ? '#374151' : '#166534', marginTop: 12, fontWeight: 700 }}>{progress}</div>}
        </section>
      </div>
    </div>
  )
...
const sectionHeaderStyle = { fontSize: 15, fontWeight: 700, color: '#111827', marginBottom: 12 }
...
const uploadBoxStyle = { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, border: '1px dashed #cbd5e1', background: '#fff', borderRadius: 10, padding: 18, fontSize: 13, fontWeight: 700, color: '#111827', cursor: 'pointer' }
...
const dangerButtonStyle = (disabled) => ({ width: '100%', marginTop: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '10px 16px', background: disabled ? '#e5e7eb' : '#dc2626', color: disabled ? '#9ca3af' : '#fff', border: 'none', borderRadius: 9, fontSize: 13, fontWeight: 700, cursor: disabled ? 'default' : 'pointer' })
