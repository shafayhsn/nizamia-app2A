      ...
      <div className="card">
        <div className="table-wrap">
          {buyers.length === 0 ? (
            ...
            <table>
              <thead><tr><th>Name</th><th>Contact</th><th>Country</th><th>Currency</th><th>Payment Terms</th><th>Default Incoterms</th><th>Ship Mode</th><th style={{ textAlign: 'right' }}>Actions</th></tr></thead>
              <tbody>
                {buyers.map(b => (
                  <tr key={b.id}>
                    ...
                    <td style={{ fontSize: 11 }}>{b.payment_terms_days ? `${b.payment_terms_days} days` : '—'}</td>
