...
function UsersAndRights() {
  ...
  if (!user) return (
    <div style={styles.container}><div style={{ ...styles.card, maxWidth: 460 }}>
      <div style={{ fontSize: 18, fontWeight: 700, marginBottom: 6 }}>Admin Login</div>
