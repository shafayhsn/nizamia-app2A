...
function UsersAndRights() {
  const { user, userRole, loading: authLoading, refreshUser, logout } = useAuth()
  ...
  const styles = {
    ...
    form: { display: 'grid', gridTemplateColumns: '1.2fr 1.2fr 1fr 150px auto auto', gap: '12px', alignItems: 'end', marginBottom: '20px' },
    ...
    return (
      <div style={styles.container}>
        <div style={{ ...styles.card, maxWidth: 460 }}>
          ...
          <div style={{ fontSize: 12, color: '#6b7280', marginBottom: 16 }}>Login with the Supabase Auth user you created as admin.</div>
          <input type="email" placeholder="Admin email" value={loginEmail} onChange={(e) => setLoginEmail(e.target.value)} style={{ ...styles.input, marginBottom: 10 }} />
