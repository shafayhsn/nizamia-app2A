...
import { Search, Printer, Layers, Plus, X, Check, AlertCircle, Copy, Upload, Download, FileText, Table, Trash2, RefreshCcw, Settings } from 'lucide-react'
      ...
      <div style={{ padding: '12px 24px', borderBottom: '1px solid #f3f4f6', display: 'flex', alignItems: 'center', gap: 14, flexShrink: 0 }}>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <button className="btn btn-secondary" style={squareBtnStyle}
            ...
            title={selected.size === 0 ? 'Select orders to print' : 'Print Orders'}>
            <Printer size={15} />
          </button>
        ...
        <>
          ...
          <div style={{ padding: '8px 24px', borderBottom: '1px solid #f3f4f6', display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
            ...
            <div style={{ marginLeft:'auto', display:'flex', gap:8, alignItems:'center' }}>
              ...
              <button className="btn btn-secondary" style={squareBtnStyle} title="Column Settings" onClick={() => {}}>
                <Settings size={15} />
              </button>
            </div>
          </div>
