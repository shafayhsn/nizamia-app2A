...
export default function Orders() {
  ...
  const renderColumnCell = (o, key) => {
    ...
    if (key === 'q_count') return <td style={{ padding: '9px 12px', borderBottom: '1px solid #f9fafb', fontSize: 12, fontWeight: 700, color: (o.q_count || 0) ? '#111827' : '#9ca3af', fontFamily: 'monospace' }} onClick={() => openEdit(o)}>{Number(o.q_count || 0)}</td>
