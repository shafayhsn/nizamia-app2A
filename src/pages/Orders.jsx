        ...
        <>
          ...
          <div style={{ padding: '8px 24px', borderBottom: '1px solid #f3f4f6', display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
            ...
            <select
              ...
              style={{ ...sortSelectStyle, minWidth: 142 }}
              title="Group orders"
            >
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 980 }}>
                ...
                <tbody>
                  {displayedRows.map(row => {
                    if (row.type === 'group') {
                      return (
                        <tr key={`group-${row.key}`} style={{ background:'#f8fafc' }}>
                          <td colSpan={1 + (visibleColumns.picture ? 1 : 0) + 3 + visibleConfigColumns.length} style={{ padding:'8px 18px', borderBottom:'1px solid #e5e7eb', borderTop:'1px solid #eef2f7' }}>
