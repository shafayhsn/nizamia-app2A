...
export default function Orders() {
  ...
  async function deleteSelected() {
    if (!await confirm(`Delete ${selected.size} order(s)?`, { title:'Delete Orders', confirmText:'Delete', tone:'danger' })) return
