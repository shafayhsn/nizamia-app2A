...
function QueuesTab({ onEditOrder }) {
  ...
  async function fetchQDocData(q) {
    ...
    // Strict custom queue rule: IOS must print ONLY the saved colour/wash × size-group
    // components assigned to the selected queue. Do not reconstruct from full matrix,
    // because that can accidentally include washes/size groups that are not in this queue.
