...
function ShipmentsTab({ shipments, shipmentLines, rows, onRefresh, onEdit }) {
  ...
  const data = shipments.map(s => {
    ...
    const cartons=lines.reduce((a,l)=>a+num(l.cartons),0) || num(s.cartons_total)
    const cbm=lines.reduce((a,l)=>a+num(l.cbm),0) || num(s.cbm_total)
