    ...
    <>
      ...
      <div style={{ flex: 1, overflowY: 'auto', overflowX: 'auto' }}>
        {loading ? (
          ...
          <div style={{ padding: 60, textAlign: 'center', color: '#9ca3af', fontSize: 12 }}>No BOM items found.</div>
        ) : (
...
export default function Purchasing() {
  ...
  useEffect(() => {
    supabase.from('orders').select('id,job_number,buyer_name,style_number,description,total_qty,buyer_id').not('status', 'eq', 'Cancelled').order('job_number')
