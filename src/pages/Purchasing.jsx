...
function DemandTab({ orders, suppliers }) {
  ...
  // Only pull BOM items for orders that have a job assigned (job_id is not null)
  const jobAssignedOrderIds = orders.filter(o => o.job_id).map(o => o.id)

  useEffect(() => {
    if (!jobAssignedOrderIds.length) { setLoading(false); return }
