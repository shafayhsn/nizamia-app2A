...
async function findUserByIdentifier(identifier) {
  ...
  const richColumns = 'id, email, username, name, display_name, role, is_active, password, password_hash'
  const basicColumns = 'id, email, role, is_active, password, password_hash'
