...
const CATEGORIES = ['Fabric', 'Trims', 'Packing', 'CMT', 'Wash', 'Print', 'Embroidery', 'Other']
      ...
      <div className="card">
        <div className="table-wrap">
          {suppliers.length === 0 ? (
            ...
            <table>
              <thead><tr><th>Name</th><th>Category</th><th>Contact</th><th>Phone</th><th>Lead Time</th><th style={{ textAlign: 'right' }}>Actions</th></tr></thead>
              <tbody>
                {suppliers.map(s => (
                  <tr key={s.id}>
